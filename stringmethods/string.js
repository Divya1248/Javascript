...
// console.log(p.replace('fox','dog')); // Thw quick brown dog jumps
// console.log(p.replace('cat','dog'));// the string reamins same
...
// //split syntax= split('seperator', "limit")
// var c="welcome to test yantra"
// var d= c.split('t',3);
// console.log(d);
